...
const DrawerList = [
  ...
  { icon: "video-vintage", label: "Videos", navigateTo: "Video" },
...
const DrawerLayout = ({ icon, label, navigateTo }) => {
  ...
  return (
    <DrawerItem
      icon={({ color, size }) => (
        <Icon name={icon} color={"maroon"} size={size} />
      )}
      label={label}
      onPress={() => {
        if (label === "Home") {
          ...
          <View style={styles.drawerContent}>
                ...
                /> */}
                  <View style={{ marginLeft: 10, flexDirection: "column" }}>
                    <Title style={styles.title}>
                      This app is made by DieXuki aka Souvik
                    </Title>
            ...
            <View>
              <Image
                ...
                source={require("./assets/nursepic.png")}
              />
            </View>
          </View>
